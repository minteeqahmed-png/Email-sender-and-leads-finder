...
=============================================================================
Author: Gemini Email Automation Engine
Description:
    Production Python email outreach script featuring:
    - Interactive startup wizard (prompts for Company, Sender Email, Pitch, Attachments/Logo)
    - Formatted pre-send confirmation preview requiring explicit user approval
    - Secure SMTP login authentication (hidden password input with getpass)
    - Context-aware personalization using Gemini 3.7 Flash
    - Attachments & Company Logo MIME encoding support
    - Anti-duplicate checkpointing ('sent_log.csv') & CAN-SPAM rate pacing
=============================================================================
"""
...
class GmailSMTPDispatcher:
    ...
    def test_connection(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"SMTP Authentication Error (535): Invalid credentials or 16-char App Password. Details: {e}"
...
export const REQUIREMENTS_TXT = `# Python dependencies for Gemini Email Automator
pandas>=2.0.0
openpyxl>=3.1.0
google-genai>=0.1.1
python-dotenv>=1.0.0
...
export const ENV_EXAMPLE_CODE = `# =================================================================
# GEMINI EMAIL AUTOMATOR ENVIRONMENT CONFIGURATION
# Copy this file to .env and fill in your credentials.
# =================================================================

# 1. Google Gemini API Key (Get free from https://aistudio.google.com)
GEMINI_API_KEY=your_gemini_api_key_here

# 2. Gmail SMTP Credentials
# NOTE: You MUST use a 16-character 'App Password', NOT your standard password.
# Setup: Google Account -> Security -> 2-Step Verification -> App Passwords
GMAIL_USER=your_email@gmail.com
GMAIL_APP_PASSWORD=abcd efgh ijkl mnop

# 3. Sender & Campaign Identity Defaults (Can be confirmed interactively on startup)
SENDER_NAME=Alex Morgan
SENDER_COMPANY=Apex Dynamics
CAMPAIGN_GOAL=Introduce our high-throughput AI infrastructure and propose a 15-minute introductory call
DEFAULT_TONE=Professional, warm, and consultative

# 4. Pacing Rate Limit (36.0s = 100 emails/hour for safe deliverability)
WAIT_TIMER_SECONDS=36.0

# 5. Exact Immutable Placeholders (Never hallucinated by Gemini)
CALENDAR_URL=https://calendly.com/your-name/15min
RESOURCE_LINK=https://example.com/growth-case-study
DEMO_DATE=Thursday at 2:00 PM EST
COMPANY_WEBSITE=https://apexdynamics.ai
`;

export const SAMPLE_CONTACTS_DATA = [
  {
    id: "1",
    Name: "Sarah Jenkins",
    Email: "sarah.jenkins@techcorp-demo.com",
    CustomContext: "VP of Engineering at CloudScale. Recently posted on LinkedIn about scaling microservices and wrestling with build pipeline bottlenecks.",
  },
  {
    id: "2",
    Name: "Marcus Vance",
    Email: "m.vance@novabio-health.io",
    CustomContext: "Head of Product at NovaBio. Launched their telemedicine app last quarter; focused on HIPAA compliant patient data pipelines.",
  },
  {
    id: "3",
    Name: "Elena Rostova",
    Email: "elena@vertex-fintech.co",
    CustomContext: "Co-Founder & CTO. Raised Series A in June; looking to automate customer onboarding and prevent transaction drop-offs.",
  },
  {
    id: "4",
    Name: "David Chen",
    Email: "david.chen@acme-logistics.net",
    CustomContext: "Operations Director at Acme Logistics. Met briefly at the TechSummit Chicago session on IoT fleet routing optimization.",
  },
  {
    id: "5",
    Name: "Amira Patel",
    Email: "amira@solardrive-energy.com",
    CustomContext: "Sustainability Lead at SolarDrive. Spoke on clean tech podcast about residential battery storage adoption curves in Texas.",
  },
];
